...
{% include figure image_path="/assets/images/slowed_ver.gif" alt="" caption="Visualization of location estimates on 9 tagged jays, each in a different color." %}{:height="50%" width="50%"}
